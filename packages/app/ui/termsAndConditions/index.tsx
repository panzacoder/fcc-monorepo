...
export const TermsAndConditions = ({
  ...
  let titleStyle = 'font-normal w-full text-[15px] text-[#1A1A1A] font-bold'
  let valueStyle = 'font-normal ml-1 w-[90%] text-[15px]  text-[#1A1A1A]'
  ...
  return (
    <View className="h-[90%] w-[95%] flex-1 self-center rounded-[15px] border-[1px] border-[#e0deda] ">
      <View className="bg-primary h-[50] w-full flex-row rounded-tl-[15px] rounded-tr-[15px]">
        <Typography className=" w-[85%] self-center text-center font-bold text-white">{`Terms and Conditions`}</Typography>
