...
import { cn, NavigationMenuPrimitive } from 'primitives'
...
>(({ className, ...props }, ref) => (
  <NavigationMenuPrimitive.List
    ref={ref}
    className={cn(
      'group flex flex-1 list-none flex-row items-center justify-center gap-1',
      className
    )}
    {...props}
  />
  ...
  return (
    <NavigationMenuPrimitive.Portal>
      <NavigationMenuPrimitive.Content
        ref={ref}
        className={cn(
          'native:border native:border-border native:rounded-lg native:shadow-lg native:bg-popover native:text-popover-foreground native:overflow-hidden left-0 top-0 w-full',
          value === itemValue
  ...
  return (
    <View className={cn('absolute left-0 top-full flex justify-center')}>
      <NavigationMenuPrimitive.Viewport
        className={cn(
          'origin-top-center border-border bg-popover text-popover-foreground web:animate-in web:zoom-in-90 relative mt-1.5 h-[var(--radix-navigation-menu-viewport-height)] w-full overflow-hidden rounded-md border shadow-lg',
          className
        )}
        ref={ref}
        {...props}
